...
<head>
  ...
  <style>
    ...
    .main {
      ...
      background:#24243e; border-radius:10px;
    ...
    input {
      width:60%; background:#e0dede;
      display:flex; margin:20px auto; padding:12px;
      border:none; outline:none; border-radius:5px;
    }
    button {
      width:60%; height:40px; margin:10px auto;
      display:block; color:#fff; background:#573b8a;
      font-size:1em; font-weight:bold; margin-top:30px;
    ...
    .login {
      ...
      border-radius:60%/10%; transform:translateY(-180px);
...
<body>
  <div class="main">
    <input type="checkbox" id="chk" aria-hidden="true">
                         <div class="arrow">
  <a href="landingpage.html"><svg xmlns="http://www.w3.org/2000/svg" width="50" height="40" fill="currentColor" class="bi bi-arrow-left" viewBox="0 0 16 16">
